...
S {}
E {}
N -880 -40 -850 -40 {lab=an}
N -880 -10 -850 -10 {lab=bn}
N -880 20 -850 20 {lab=cin}
...
N -580 240 -390 240 {lab=DGND}
N -580 -90 -500 -90 {lab=DGND}
N -500 -90 -480 -90 {lab=DGND}
N -480 -90 -480 240 {lab=DGND}
N -580 -260 -390 -260 {lab=DVDD}
N -580 80 -470 80 {lab=DVDD}
N -470 -260 -470 80 {lab=DVDD}
N -580 -230 -570 -230 {lab=DVDD}
N -570 -260 -570 -230 {lab=DVDD}
N -580 210 -570 210 {lab=DGND}
N -570 210 -570 240 {lab=DGND}
N -580 110 -570 110 {lab=DVDD}
N -570 80 -570 110 {lab=DVDD}
N -580 -120 -570 -120 {lab=DGND}
N -570 -120 -570 -90 {lab=DGND}
N -580 -200 -580 -150 {lab=a}
N -620 -230 -620 -120 {lab=an}
N -620 110 -620 210 {lab=bn}
N -580 140 -580 180 {lab=b}
N -580 -170 -570 -170 {lab=a}
N -580 150 -570 150 {lab=b}
C {ipin.sym} -880 -40 0 0 {name=p1 lab=an}
C {ipin.sym} -880 -10 0 0 {name=p2 lab=bn}
C {ipin.sym} -880 20 0 0 {name=p3 lab=cin}
C {lab_pin.sym} -570 -170 0 1 {name=p7 sig_type=std_logic lab=a}
C {lab_pin.sym} -570 150 0 1 {name=p8 sig_type=std_logic lab=b}
C {lab_pin.sym} -850 20 0 1 {name=p9 sig_type=std_logic lab=cin}
...
C {sky130_fd_pr/pfet_01v8.sym} -600 -230 0 0 {name=M15
W=0.84
L=0.15
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} -600 -120 0 0 {name=M16
W=0.42
L=0.15
nf=1 
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -600 110 0 0 {name=M17
W=0.84
L=0.15
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} -600 210 0 0 {name=M18
W=0.42
L=0.15
nf=1 
mult=1
...
C {lab_pin.sym} -850 -40 0 1 {name=p16 sig_type=std_logic lab=an}
C {lab_pin.sym} -850 -10 0 1 {name=p17 sig_type=std_logic lab=bn}
C {lab_pin.sym} -620 -180 0 0 {name=p26 sig_type=std_logic lab=an}
C {lab_pin.sym} -620 160 0 0 {name=p27 sig_type=std_logic lab=bn}
