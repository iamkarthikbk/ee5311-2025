...
N -150 -60 -150 -40 {lab=GND}
N -150 -80 -150 -60 {lab=GND}
N -150 -100 -150 -80 {lab=GND}
N -150 -120 -150 -100 {lab=GND}
N -150 -140 -150 -120 {lab=GND}
N -150 -160 -150 -140 {lab=GND}
N -170 -160 -150 -160 {lab=GND}
N -150 -0 -150 20 {lab=VDD}
N -150 20 -150 40 {lab=VDD}
N -150 40 -150 60 {lab=VDD}
N -160 60 -150 60 {lab=VDD}
N -160 60 -160 100 {lab=VDD}
N -160 100 -150 100 {lab=VDD}
N -150 100 -150 120 {lab=VDD}
N -150 120 -150 140 {lab=VDD}
N -150 140 -150 160 {lab=VDD}
C {rca8b.sym} 0 0 0 0 {name=x1}
C {vdd.sym} 150 -160 0 0 {name=l1 lab=VDD}
C {gnd.sym} 170 -40 0 0 {name=l2 lab=GND}
C {lab_pin.sym} -170 80 3 0 {name=p3 sig_type=std_logic lab=cin_tap}
...
C {vsource.sym} -190 110 0 0 {name=V1 value="PULSE(0 1.8 0 50ps 50ps 5ns 10ns)" savecurrent=false}
C {gnd.sym} -190 140 0 0 {name=l5 lab=GND}
