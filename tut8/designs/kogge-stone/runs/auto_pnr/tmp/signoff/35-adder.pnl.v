module adder (VGND,
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_0_55 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_0_0_60 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_0_0_88 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_0_0_93 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_16_53 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_4 FILLER_0_16_6 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_4_38 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_4 FILLER_0_4_50 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_7_81 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_8 FILLER_0_7_9 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__or2_1 _075_ (.A(\a_q[0] ),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__nand2_1 _076_ (.A(\a_q[0] ),
    .B(\b_q[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _089_ (.A(\a_q[3] ),
    ...
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__and2_1 _090_ (.A(\a_q[3] ),
    .B(\b_q[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__nor2_1 _091_ (.A(_045_),
    .B(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _092_ (.A1(_041_),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__xnor2_1 _093_ (.A(_047_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o221a_1 _120_ (.A1(_068_),
    ...
    .VPWR(VPWR),
    .X(_071_));
 sky130_fd_sc_hd__o31a_1 _121_ (.A1(_055_),
    .A2(_061_),
    .A3(_070_),
    .B1(_071_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _124_ (.A(_073_),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__xor2_1 _125_ (.A(_072_),
    .B(_000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _126_ (.A(\a_q[9] ),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__o21a_1 _127_ (.A1(_072_),
    .A2(_000_),
    .B1(_073_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _132_ (.A1(\a_q[9] ),
    ...
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__o21a_1 _133_ (.A1(_072_),
    .A2(_004_),
    .B1(_006_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _148_ (.A(_018_),
    ...
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__xor2_1 _149_ (.A(_017_),
    .B(_020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _152_ (.A(_021_),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__a21o_1 _153_ (.A1(_017_),
    .A2(_020_),
    .B1(_018_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _157_ (.A(_025_),
    ...
    .VPWR(VPWR),
    .Y(_027_));
 sky130_fd_sc_hd__a211oi_1 _158_ (.A1(_017_),
    .A2(_020_),
    .B1(_022_),
    .C1(_018_),
    .VGND(VGND),
