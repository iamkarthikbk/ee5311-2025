...
N -70 80 120 80 {lab=GND}
N -220 -0 -160 -0 {lab=Vin}
N -180 -15 -180 -0 {lab=Vin}
N -70 -0 30 -0 {lab=Vout}
N -0 -25 0 -0 {lab=Vout}
C {inv_nognd.sym} -10 10 0 0 {name=x1}
C {inv_nognd.sym} 180 10 0 0 {name=x2}
C {gnd.sym} -220 100 0 0 {name=l1 lab=GND}
C {vsource.sym} -220 30 0 0 {name=Vin1 value="PULSE(0 \{vdd_val\} 10ps 5ps 5ps 100ps 250ps)" savecurrent=false}
